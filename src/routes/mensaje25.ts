...
// Crea mensaje de chat de un espectador, suma +1 punto y notifica si sube de nivel.
router.post("/streams/:streamId/mensajes", async (req: Request, res: Response, next: NextFunction) => {
  ...
  try {
    ...
    const msgRes = await client.query(
      ...
      [streamId, viewer.usuario_id, mensaje.trim(), levelResult.nuevoNivel ?? viewer.nivel_actual]
    );
